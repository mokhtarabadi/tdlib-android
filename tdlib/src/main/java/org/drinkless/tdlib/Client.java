...
public final class Client {
	...
	public interface ExceptionHandler {
		 ...
		 *
		 * @param e
		 *            Exception thrown by ResultHandler.
		 */
	...
	public interface LogMessageHandler {
		 ...
		 *            Log verbosity level with which the message was added from -1 up to
		 *            1024. If 0, then TDLib will crash as soon as the callback returns.
		 *            None of the TDLib methods can be called from the callback.
		 * @param message
		 *            The message added to the internal TDLib log.
		 */
	...
	public static class ExecutionException extends Exception {
		...
		/**
		 * @param error
		 *            TDLib error occurred while performing
		 *            {@link #execute(TdApi.Function)}.
		 */
	 ...
	 * @param resultHandler
	 *            Result handler with onResult method which will be called with
	 *            result of the query or with TdApi.Error as parameter. If it is
	 *            null, nothing will be called.
	 ...
	 *            Result handler with onResult method which will be called with
	 *            result of the query or with TdApi.Error as parameter. If it is
	 *            null, then defaultExceptionHandler will be called.
	 */
	 ...
	 * @param updateExceptionHandler
	 *            Handler for exceptions thrown from updateHandler. If it is null,
	 *            exceptions will be iggnored.
	 * @param defaultExceptionHandler
	 *            Default handler for exceptions thrown from all ResultHandler. If
	 ...
	 *
	 * @param maxVerbosityLevel
	 *            The maximum verbosity level of messages for which the callback
	 *            will be called.
